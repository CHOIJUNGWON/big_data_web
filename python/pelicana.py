...
def getPelicanaAddress(result):
    for page_idx in count():
        ...
        Pelicana_URL = 'http://www.pelicana.co.kr/store/stroe_search.html'
        ...
        for store_tr in tbody.findAll('tr'):
            ...
            store_name = tr_tag[1]
            store_adderss = tr_tag[3]
            store_sido_gu = store_adderss.split()[:2]

            result.append([store_name] + store_sido_gu + [store_adderss])
        if (bEnd == True):
            return
